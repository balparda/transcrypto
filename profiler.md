...
│ --confidence          -c                 INTEGER RANGE [50<=x<=99]   Confidence level to evaluate measurements at as int percentage points │
│                                                                      [50,99], inclusive, representing 50% to 99%                           │
│                                                                                                                               │
│ --bits                -b                 TEXT                        Bit lengths to investigate as "int,int,int"; behaves like arguments   │
│                                                                      for range(), i.e., "start,stop,step", eg. "1000,3000,500" will        │
│                                                                      investigate 1000,1500,2000,2500                                       │
│                                                                                                                   │
