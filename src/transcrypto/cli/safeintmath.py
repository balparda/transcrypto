...
@safecrypto.app.command(
  'isprime',
  help='Primality test with safe defaults, useful for any integer size.',
  epilog=(
    'Example:\n\n\n\n'
    '$ poetry run safecrypto isprime 2305843009213693951\n\n'
    'True\n\n'
    '$ poetry run safecrypto isprime 2305843009213693953\n\n'
    'False'
  ),
)
...
def IsPrimeCLI(  # documentation is help/epilog/args # noqa: D103
  *,
  ...
  n_i: int = safecrypto.ParseInt(n, min_value=1)
...
def PrimeGenCLI(  # documentation is help/epilog/args # noqa: D103
  *,
  ...
  config: safecrypto.TransConfig = ctx.obj
  start_i: int = safecrypto.ParseInt(start, min_value=0)
...
@safecrypto.app.command(
  ...
  epilog=(
    'Example:\n\n\n\n'
    '$ poetry run safecrypto mersenne -k 0 -m 15\n\n'
    'k=2  M=3  perfect=6\n\n'
    'k=3  M=7  perfect=28\n\n'
...
@safecrypto.app.command(
  ...
  epilog=(
    ...
    '21\n\n'
    '$ poetry run safecrypto gcd 0 5\n\n'
    '5\n\n'
    '$ poetry run safecrypto gcd 127 13\n\n'
    '1'
  ),
)
@clibase.CLIErrorGuard
def GcdCLI(  # documentation is help/epilog/args # noqa: D103
  *,
  ...
  config: safecrypto.TransConfig = ctx.obj
  a_i: int = safecrypto.ParseInt(a, min_value=0)
  b_i: int = safecrypto.ParseInt(b, min_value=0)
  if a_i == 0 and b_i == 0:
...
@safecrypto.app.command(
  ...
  epilog=(
    'Example:\n\n\n\n'
    '$ poetry run safecrypto xgcd 462 1071\n\n'
    '(21, 7, -3)\n\n'
    '$ poetry run safecrypto xgcd 0 5\n\n'
    '(5, 0, 1)\n\n'
...
safecrypto.app.add_typer(mod_app, name='mod')
...
@mod_app.command(
  ...
  epilog=(
    'Example:\n\n\n\n'
    '$ poetry run safecrypto mod inv 127 13\n\n'
    '4\n\n'
    '$ poetry run safecrypto mod inv 17 3120\n\n'
    '2753\n\n'
    '$ poetry run safecrypto mod inv 462 1071\n\n'
...
def ModInv(  # documentation is help/epilog/args # noqa: D103
  *,
  ...
  config: safecrypto.TransConfig = ctx.obj
  a_i: int = safecrypto.ParseInt(a)
  m_i: int = safecrypto.ParseInt(m, min_value=2)
  try:
...
@mod_app.command(
  ...
  epilog=(
    ...
    '11\n\n'
    '$ poetry run safecrypto mod div 6 0 13\n\n'
...
def ModDiv(  # documentation is help/epilog/args # noqa: D103
  *,
  ...
  config: safecrypto.TransConfig = ctx.obj
  x_i: int = safecrypto.ParseInt(x)
  y_i: int = safecrypto.ParseInt(y)
  m_i: int = safecrypto.ParseInt(m, min_value=2)
  try:
...
@mod_app.command(
  ...
  epilog=(
    ...
    '32\n\n'
    '$ poetry run safecrypto mod exp 438 234 89854\n\n'
    '60622'
  ),
)
@clibase.CLIErrorGuard
def ModExp(  # documentation is help/epilog/args # noqa: D103
  *,
  ...
  config: safecrypto.TransConfig = ctx.obj
  a_i: int = safecrypto.ParseInt(a)
  e_i: int = safecrypto.ParseInt(e, min_value=0)
  m_i: int = safecrypto.ParseInt(m, min_value=2)
...
@mod_app.command(
  ...
  epilog=(
    ...
    '$ poetry run safecrypto mod poly 10 97 3 0 0 1 1\n\n'
...
def ModPoly(  # documentation is help/epilog/args # noqa: D103
  *,
  ...
  x_i: int = safecrypto.ParseInt(x)
  m_i: int = safecrypto.ParseInt(m, min_value=2)
  coeff_i: list[int] = [safecrypto.ParseInt(z) for z in coeff]
...
@mod_app.command(
  ...
  epilog=(
    ...
    '$ poetry run safecrypto mod lagrange 11 97 1:1 2:4 3:9 4:16 5:25\n\n'
...
def ModLagrange(  # documentation is help/epilog/args # noqa: D103
  *,
  ...
  x_i: int = safecrypto.ParseInt(x)
  m_i: int = safecrypto.ParseInt(m, min_value=2)
  pts: dict[int, int] = dict(safecrypto.ParseIntPairCLI(kv) for kv in pt)
...
@mod_app.command(
  ...
  epilog=(
    ...
    '62\n\n'
    '$ poetry run safecrypto mod crt 12 56 17 19\n\n'
    '796\n\n'
    '$ poetry run safecrypto mod crt 6 7 462 1071\n\n'
...
def ModCRT(  # documentation is help/epilog/args # noqa: D103
  *,
  ...
  config: safecrypto.TransConfig = ctx.obj
  a1_i: int = safecrypto.ParseInt(a1)
  m1_i: int = safecrypto.ParseInt(m1, min_value=2)
  a2_i: int = safecrypto.ParseInt(a2)
  m2_i: int = safecrypto.ParseInt(m2, min_value=2)
  try:
