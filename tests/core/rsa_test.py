...
"""core/rsa.py unittest.

Run with:
  poetry run pytest -vvv tests/core/rsa_test.py
"""
...
def test_RSA_raw(
  ...
  message: int,
  expected_cypher: int,
  expected_obfuscated: int,
  expected_signed: int,
  expected_obfuscated_signed: int,
) -> None:
  """Test."""
  # create keys
  ob = rsa.RSAObfuscationPair(
    public_modulus=public_modulus,
    encrypt_exp=encrypt_exp,
